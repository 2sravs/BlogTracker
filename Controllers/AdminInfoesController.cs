    ...
    public class AdminInfoesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AdminInfo != null ? 
                          ...
                          Problem("Entity set 'BlogTrackerContext.AdminInfo'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var adminInfo = await _context.AdminInfo
                .FirstOrDefaultAsync(m => m.AdminInfoId == id);
            if (adminInfo == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("AdminInfoId,EmailId,Password")] AdminInfo adminInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminInfoId,EmailId,Password")] AdminInfo adminInfo)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!AdminInfoExists(adminInfo.AdminInfoId))
                    {
                        return NotFound();
                    }
                    else
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BlogTrackerContext.AdminInfo'  is null.");
            }
            var adminInfo = await _context.AdminInfo.FindAsync(id);
            if (adminInfo != null)
            {
        ...
        {
          return (_context.AdminInfo?.Any(e => e.AdminInfoId == id)).GetValueOrDefault();
        }
    }
}
